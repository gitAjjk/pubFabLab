...
# TODO: 
#   offset 'Arc', not 'Intersection' because circels become lotof small lines
#   auto orthogonal view ?
#   group tmp's in a part and delete afterwards?

#Requester for kerf offset
from PySide2 import QtWidgets
def RequesterForOffset(default_value=0.1):
    # Prepare dialog
...
offset = RequesterForOffset(default_value=0.1)
...
for obj in selectedObjects:
    ...
    tmpNameOffset = "tmpOffset3D_"+ obj.Name
    ...
    doc.recompute()
    AddViewToTechdrawpage(pageTechdraw, newOffset3D, "tmpOffset3D_"+ obj.Name, kerf)
